                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">Manage Vehicle Owners</span><i
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side1">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="../vehicle-owners" class="slide-item">Vehicle Owners List</a></li>

                                                        <li><a href="../vehicle-owners/add-vehicle-owners.html" class="slide-item">Add Vehicle Owners</a></li>
													</ul>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">Manage Vehicles</span><i
                                        class="angle fe fe-chevron-right"></i>
                                </a>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-package"></i><span
                                        class="side-menu__label">Manage Service Package</span><i
                                        class="angle fe fe-chevron-right"></i>
                                </a>
								<ul class="slide-menu mega-slide-menu">
                                    <li class="panel sidetab-menu">
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Edit Vehicle Owner</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Vehicle Owner</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Vehicle Owner</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">NIC <span class="text-red">*</span></label>
                                                    <input type="email" class="form-control" placeholder="National Identity Card" autocomplete="NIC">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Main Phone Number" autocomplete="Phone Nuumber">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" placeholder="Other Phone Number" autocomplete="Phone Number">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Street Name <span class="text-red">*</span></label>
