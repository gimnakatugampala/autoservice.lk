                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Vehicle Owners</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Vehicle Owners</li>
                                </ol>

                                <div class="mt-4">
                                    <a href="../vehicle-owners/add-vehicle-owners.php" class="btn btn-primary"><i class="fa fa-plus" ></i> Add Vehicle Owner</a>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">All Vehicle Owners</h3>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>61</td>
                                                        <td>
                                                            <a href="../vehicle-owners/vehicle-owner-details.php" class="btn btn-primary"><i class="fa fa-eye"></i></a>

                                                            <a href="../vehicle-owners/edit-vehicle-owners.php" class="btn btn-info"><i class="fa fa-pencil" ></i></a>
                                                        </td>
                                                    </tr>
