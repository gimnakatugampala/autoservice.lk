  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-weight-bold text-dark"><i class="fas fa-cart-plus mr-2 text-primary"></i>Add Purchase Order</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline shadow-sm">
              <div class="card-header border-0">
                <h3 class="card-title text-bold">Order Header Details</h3>
              </div>
              <div class="card-body">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-bold text-success" id="paid_amount" placeholder="0.00">
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-5">
                <div class="summary-box shadow-sm mb-4">
                    ...
                    <table class="table table-sm table-borderless font-weight-bold mb-0">
                      ...
                      <tr>
                        ...
                        <td class="text-right"><input type="text" value="0" class="form-control form-control-sm w-50 ml-auto text-right" id="vat"></td>
                      </tr>
                      ...
                      <tr class="border-top border-primary">
                        ...
                        <td class="text-lg text-primary text-right"><span id="to_be_paid" style="text-decoration: underline; text-decoration-style: double;">0.00</span></td>
                      </tr>
                    </table>
                    </div>
                </div>
                ...
                <button id="btn_add_purchase" type="button" class="btn btn-primary px-5 shadow-sm font-weight-bold">
