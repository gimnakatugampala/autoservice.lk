...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../dashboard/" class="brand-link text-center">
      <img src="../assets/img/system/autoservice_logo.jpg" alt="Autoservice.lk Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../assets/img/logso.png" class="img-circle elevation-2 img-bordered-sm" alt="User Image">
        </div>
        <div class="info">
          <a id="logged-in-user" href="#" class="d-block"></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../vehicles/add-vehicle.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Vehicle</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../employees/add-employee.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Employee</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../washer/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Washers List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../washer/add-washer.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Washer</p>
                </a>
              </li>
