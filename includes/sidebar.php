                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="side5">
                                            <ul class="sidemenu-list mega-menu-list">
                                                ...
                                                <li><a href="../vehicles" class="slide-item">Vehicles List</a></li>

                                                <li><a href="../vehicles/add-vehicle.php" class="slide-item">Add Vehicle</a></li>
                                ...
                                <div class="panel-body tabs-menu-body p-0 border-0">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="side5">
                                            <ul class="sidemenu-list mega-menu-list">
                                                <li class="side-menu-label1"><a href="javascript:void(0)">Bootstrap</a></li>
                                                <li><a href="../service-packages/" class="slide-item">Service Package List</a></li>
                                                <li><a href="../service-packages/add-service-package.php" class="slide-item">Add Service Package</a></li>
                                            </ul>
                                            <div class="menutabs-content mt-5 p-0">
                                                <div class="Annoucement_card">
                                                    <div class="text-center">
