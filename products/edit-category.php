  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-weight-bold text-dark"><i class="fas fa-edit mr-2 text-info"></i>Edit Category</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-8 mx-auto">
            ...
            <div class="card card-info card-outline shadow-sm">
              <div class="card-header border-0">
                <h3 class="card-title text-bold">Update Category Details</h3>
              </div>
              <div class="card-body">
              ...
              <div class="col-md-12">
                    <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control font-weight-bold" id="category_name" placeholder="Name">
                          </div>
                      </div>
                </div>
                ...
                <div class="col-md-12 mt-3 border-top pt-3 text-right">
                    ...
                    <button id="btn_update_category" type="button" class="btn btn-info px-5 shadow-sm">Update</button>
                </div>
