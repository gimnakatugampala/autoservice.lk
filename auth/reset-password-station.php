...
<style>
    ...
    .alert-box.success { background: var(--success-bg); border: 1.5px solid var(--success-bdr); color: var(--success); }
    .alert-box.warning { background: var(--warning-bg); border: 1.5px solid var(--warning-bdr); color: var(--warning); }
...
<div class="reset-card">
    ...
    <div class="card-brand">
        ...
        <div class="brand-title">Station Password Reset</div>
    ...
    <div class="state-screen">
        ...
        <a href="../auth/station-login.php" class="btn-primary-link">
    ...
    <div class="state-screen">
        ...
        <a href="../auth/station-login.php" class="btn-outline">
    ...
    <div class="reset-heading">
        ...
        <p>Pick a strong, unique password for your station account.</p>
    </div>
