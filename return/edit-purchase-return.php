  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-weight-bold text-dark"><i class="fas fa-edit mr-2 text-info"></i>Edit Purchase Order Return</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Manage Purchase Order Return</a></li>
              <li class="breadcrumb-item active">Edit Purchase Order Return</li>
            </ol>
          </div>
          ...
          <div class="col-12">
            ...
            <div class="card card-info card-outline shadow-sm">
              <div class="card-header border-0">
                <h3 class="card-title text-bold"><i class="fas fa-file-alt mr-1"></i> Return Transaction Details</h3>
              </div>
              <div class="card-body">
              ...
              <div class="col-md-6">
                ...
                <label for="purchase-date">Purchase Return Date <span class="text-danger">*</span></label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" id="purchase-date" class="form-control datetimepicker-input shadow-none" data-target="#reservationdate"/>
                ...
                <div class="form-group">
                        ...
                        <textarea id="return_note" class="form-control shadow-none" rows="3" placeholder="Enter additional information regarding this return..."></textarea>
                      </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-borderless font-weight-bold mb-0">
                          ...
                          <tr>
                            ...
                            <td class="text-right">
                                <input type="text" value="0" class="form-control form-control-sm w-50 ml-auto text-right font-weight-bold" id="vat">
                            </td>
                          </tr>
                          ...
                          <tr class="border-top border-info">
                            ...
                            <td class="text-right text-lg text-info font-weight-bold">
                                <span id="to_be_paid" style="text-decoration: underline; text-decoration-style: double;">0.00</span>
                            </td>
                          </tr>
                        </table>
                    </div>
                ...
                <div class="col-md-12 text-right border-top pt-3">
                    ...
                    <button id="update_pruchase_order_return_btn" type="button" class="btn btn-info px-5 shadow-sm font-weight-bold">
                        <i class="fas fa-save mr-1"></i> Update Return Order
                    </button>
                </div>
