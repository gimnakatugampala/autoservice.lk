              ...
              <div class="card-body p-2">
                ...
                <div class="bs-stepper">
                  <div class="row bs-stepper-header" role="tablist">
                    ...
                    <div class="line"></div>
                    <div class="col-md-2">
                    <div class="step" data-target="#washers-parts">
                      <button type="button" class="step-trigger" role="tab" aria-controls="washers-parts" id="washers-parts-trigger">
                        <span class="bs-stepper-circle">2</span>
                        <span class="bs-stepper-label">Washers Package</span>
                      </button>
                    </div>
                    </div>
                ...
                <div id="search-vehicle-part" class="content" role="tabpanel" aria-labelledby="search-vehicle-part-trigger">
                  ...
                  <!-- Washers Package - Step 2 -->
                  <div id="washers-parts" class="content" role="tabpanel" aria-labelledby="washers-parts-trigger">
