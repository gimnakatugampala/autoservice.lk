...
$StationName = $data_station[0]['service_name'];
$modified_number = "94" . substr($data_vehicle[0]['phone'], 1); 



    $msg = "
    Thank you for choosing ($StationName) for your vehicle [$vehicle_number].Code:[$jobcardcode].Type:[$job_card_type_name].Status:[$status_name].";
    ...
    $to = "$modified_number"; // string | Number to send the SMS. Better to use 9471XXXXXXX format.
    $sender_id = "AUTOSERV.LK"; // string | This is the from name recipient will see as the sender of the SMS. Use \\\"NotifyDemo\\\" if you have not ordered your own sender ID yet.
