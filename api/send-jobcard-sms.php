...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $msg = "
    Hi $VehicleOwner,This is a friendly reminder from (Pistona Automotive Solutions) that it's time to service your vehicle [$VehicleNumber].Best regards,Pistona Automotive Solutions.
    ";
