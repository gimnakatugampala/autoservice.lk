...
//     $msg = "
//     Dear Customer,Thank you for Selecting (Pistona Automotive Solutions) to maintain your vehicle [$vehicle_number].Your Job Card Code:[$jobcardcode].Job Card Type:[$job_card_type_name]. Status:[$status_name].
//     ";


//     $api_instance = new NotifyLk\Api\SmsApi();
//     $user_id = "26703"; // string | API User ID - Can be found in your settings page.
//     $api_key = "VOnN2XbiOvr8spLCC3vd"; // string | API Key - Can be found in your 
