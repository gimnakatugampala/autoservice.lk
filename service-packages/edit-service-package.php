                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Edit Service Package</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Service Packages</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Service Package</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Service Package Name <span class="text-red">*</span></label>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                            <label class="form-label">Default Service Package Price <span class="text-red">*</span></label>
