  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-weight-bold text-dark"><i class="fas fa-oil-can mr-2 text-primary"></i>Add Lubricant Type</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-8 mx-auto">
            ...
            <div class="card card-primary card-outline shadow-sm">
              <div class="card-header">
                <h3 class="card-title text-bold">Lubricant Specification</h3>
              </div>
              <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                          <label for="fuel_type">Lubricant Type Name <span class="text-danger">*</span></label>
                          <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-flask"></i></span>
                            </div>
                            <input type="text" class="form-control" id="fuel_type" placeholder="e.g. Synthetic Oil 5W-30">
                          </div>
                      </div>
                </div>
                ...
                <div class="col-md-12 mt-3 border-top pt-3 text-right">
                    ...
                    <button id="btn_fuel_type" type="button" class="btn btn-primary px-5 shadow-sm">Submit Type</button>
